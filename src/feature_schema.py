...
EXTRACTOR_FEATURE_SUFFIXES = {
    ...
    "Spatial texture": ["avg_dm_gradient_mag", "radial_mass_index", "polar_gradient_index"],
}
...
# _fit_uncategorized_suffixes(); "Lifetime fit free", "Intensity texture", "Dry-mass statistics" and
# "Spatial texture" emit none.
