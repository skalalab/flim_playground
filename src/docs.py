...
generalInfo = f"""This tool can be run in two modes: **Online** and **Offline**. You can access the online mode by clicking on this [link]({deployed_url}). The source code is hosted at [Github]({github_repo_url}). \
